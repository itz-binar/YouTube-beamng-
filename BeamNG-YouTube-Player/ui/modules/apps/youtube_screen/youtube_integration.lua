local remoteExe = 'https://github.com/yt-dlp/yt-dlp/releases/download/2023.03.04/yt-dlp.exe'
...
local YoutubeVideo = class('YoutubeVideo', function (data)
    return setmetatable(data, { __index = YoutubeVideo })
end)

-- add YoutubeVideo class to Youtube table
